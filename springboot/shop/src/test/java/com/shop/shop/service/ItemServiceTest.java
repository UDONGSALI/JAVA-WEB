...
public class ItemServiceTest {
    ...
    List<MultipartFile> createMultipartFiles()throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            String imgeName = "image" + i + ".jpg";
            MockMultipartFile multipartFile = new MockMultipartFile(path, imgeName, "image/jpg", new byte[]{1, 2, 3, 4});
    ...
    void saveItem() throws Exception {
        ...
        Long itemId = itemService.saveItme(itemFormDto, multipartFileList);
