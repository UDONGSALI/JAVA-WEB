...
public class FileService {
    ...
    public String uploadFile(String uploadPath, String originalFileName, byte[] fileData)throws Exception {
        ...
        String fileUpoladFullUrl = uploadPath + "/" + savedFileName;
        FileOutputStream fos = new FileOutputStream(fileUpoladFullUrl); // 바이트 단위의 출력을 내보내는 클래스로서 생성자로 파일이 저장될 위치와 파일의 이름을 넘겨  파일에 쓸 파일 출력 스트림을 만든다.
