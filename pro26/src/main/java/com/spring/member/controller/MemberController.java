...
public interface MemberController {
	...
	ModelAndView addMember(@ModelAttribute("member") MemberVO member,
	...
	ModelAndView updateMember(@ModelAttribute MemberVO member, HttpServletRequest request, HttpServletResponse response) throws Exception;
